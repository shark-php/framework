...
namespace Shark\Http\Route\Dispatcher;

use Shark\Http\Route\Router as Router;
use FastRoute\Dispatcher\GroupCountBased as FastDispatcherGroupCountBased;

class RouteDispatcher extends FastDispatcherGroupCountBased
{
    private array $staticRouteMiddlewares = [];
    ...
    private function groupRouteMiddlewares($routes): void
    {
